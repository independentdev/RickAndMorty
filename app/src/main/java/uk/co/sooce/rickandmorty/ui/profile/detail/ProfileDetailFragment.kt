...
import uk.co.sooce.rickandmorty.databinding.FragmentProfileDetailBinding
import uk.co.sooce.rickandmorty.util.autoCleared

@AndroidEntryPoint
class ProfileDetailFragment : Fragment() {

    private var binding: FragmentProfileDetailBinding by autoCleared()
    ...
    private fun bindCharacter(character: MovieCharacter) {
